...
<center>
    ...
    <audio controls="controls" src="/files/dft/A4.wav" type="audio/wav"></audio>
</center>

As you can see in the figure above, the wave covered 4.4 periods in 0.01 seconds.

A computer can't record a continous wave of always-changing intensities, because there are infinite points on a continuous line. So it samples the pressure value thousands of times within a second. Like take a sample at $$1/1000$$th of a second, then at $$2/1000$$th and so on.
...
<center>
    ...
    <audio controls="controls" src="/files/dft/C4_E4.wav" type="audio/wav"></audio>
</center>
